            ...
            <div className="container mx-auto px-4 py-8 max-w-5xl">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    <StatCard
                        ...
                        label={t('statTotalReferred')}
                        value={stats.totalReferrals}
                        suffix={t('statTotalReferredSuffix')}
                    />
                    <StatCard
                        icon={<Gift size={20} className="text-yellow-400" />}
                        label={t('statPointsEarned')}
                        value={stats.totalPoints}
                        suffix={t('statPointsEarnedSuffix')}
                    />
                    <StatCard
                        icon={<TrendingUp size={20} className="text-green-400" />}
                        label={t('statActiveToday')}
                        value={stats.activeToday}
                        suffix={t('statActiveTodaySuffix')}
                    />
                    <StatCard
                        icon={<Calendar size={20} className="text-purple-400" />}
                        label={t('statWeeklyActive')}
                        value={stats.activeThisWeek}
                        suffix={t('statWeeklyActiveSuffix')}
                    />
                </div>
